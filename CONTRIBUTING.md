...
or a build from other sources than the current ones: every served site
...
A claim whose only evidence would be a manual session is written as not yet
verified, and its row says so.
